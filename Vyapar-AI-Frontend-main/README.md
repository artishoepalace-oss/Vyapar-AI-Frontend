...
# Vexto AI - Final Developer Package

Vexto AI is an offline-first business manager for small retailers.
...
```text
GitHub → Actions → Build Vexto AI Android APK → Run workflow
```
